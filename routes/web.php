...
Route::prefix('admin')->group(function () {
    ...
    Route::prefix('product')->group(function () {
        ...
        Route::get('/edit/{id}', [Backend::class, 'productedit'])->name('admin.productedit');
        Route::get('/show/{id}', [Backend::class, 'productshow'])->name('admin.productshow');
    });
    Route::prefix('category')->group(function () {
        ...
        Route::get('/edit/{id}', [Backend::class, 'categoryedit'])->name('admin.categoryedit');
        Route::get('/show/{id}', [Backend::class, 'categoryshow'])->name('admin.categoryshow');
    });

    Route::prefix('user')->group(function () {
        Route::get('/', [Backend::class, 'userlist'])->name('admin.userlist');
        Route::get('/show/{id}', [Backend::class, 'usershow'])->name('admin.usershow');
    });
});
