                                                        ...
                                                        <table class="table table-responsive table-hover table-responsive round">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>3350</td>
                                                                    <td>3500</td>
                                                                    <td><a href="{{route('admin.productshow',2)}}" class="text-light"><button type="submit" class="btn btn-info w-100">View</button></a></td>
                                                                    <td><a href="{{route('admin.productedit',2)}}" class="text-light"><button type="submit" class="btn btn-primary w-100">UPDATE</button></a></td>
